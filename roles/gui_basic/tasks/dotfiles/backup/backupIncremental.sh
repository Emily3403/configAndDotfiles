...
if [ "$(ssh -o BatchMode=yes -o ConnectTimeout=30 nas echo uwu 2>&1)" != "uwu" ]; then
    echo "[ERROR] Could not reach the NAS after 30s of waiting. Bailing out!"
    exit_and_write_to_file
fi
